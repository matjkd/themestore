...
$paypal_email = array('id'=>'paypal_email', 'class'=>'span2', 'name'=>'paypal_email', 'value'=> set_value('paypal_email', $customer['paypal_email']));
		...
		<?php echo form_open('secure/my_account'); ?>
			<fieldset>
				...
				<div class="row">
					...
					<div class="row">
					<div class="span4">
						<label for="paypal_email">Paypal Email (for sending payment)</label>
